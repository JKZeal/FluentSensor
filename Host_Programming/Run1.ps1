...
$fluentPath = Join-Path -Path $scriptPath -ChildPath "fluent1.py"
...
Write-Host "fluent1.py (PID: $($fluentProcess.Id))和router.py (PID: $($routerProcess.Id))已启动。" -ForegroundColor Green
